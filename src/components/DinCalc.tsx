...
import { recommendDin, type SkierStyle } from '../lib/recommend';

/**
 * ISO 11088 간이 버전 DIN 참고값 계산기.
 * 계산 로직은 lib/recommend.ts를 공유한다. 실제 조정은 반드시 장비샵에서.
 */
export function DinCalc() {
  ...
  const din = valid ? recommendDin(w, h, s, type, ageFlag) : null;
